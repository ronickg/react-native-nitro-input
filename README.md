...
<p align="center"><sub>The example app on an iPhone 13 Pro Max (left) and a Pixel 10 (right). Left: the market showcase, fourteen coins with price and 24 h change, a handful ticking every 200 ms, the balance derived from them. Right: an amount typed into a reflowing <code>NitroInput</code>, formatted as it is typed. Every number is native.</sub></p>
