...
| Implementation | footprint per copy | malloc per copy | left behind per copy | runs |
| --- | --- | --- | --- | --- |
| TextInput (text) | 135.7 KB | 87.2 KB | 125.1 KB | 1 |
| **NitroInput (text)** | 135.0 KB | 131.4 KB | 136.0 KB | 1 |
| **MorphInput (text)** | 96.3 KB | 55.2 KB | 97.6 KB | 1 |

#### iPhone 11 Pro (iPhone12,3, iOS 26.6.1, 60 Hz)

| Implementation | footprint per copy | malloc per copy | left behind per copy | runs |
| --- | --- | --- | --- | --- |
| TextInput (text) | 112.6 KB | 88.1 KB | 91.2 KB | 1 |
| **NitroInput (text)** | 140.2 KB | 129.7 KB | 139.5 KB | 1 |
| **MorphInput (text)** | 79.0 KB | 66.6 KB | 79.4 KB | 1 |

#### Samsung Galaxy A22 (SM-A225F, Android 13 (API 33), 90 Hz)

| Implementation | footprint per copy | malloc per copy | Java heap per copy | left behind per copy | runs |
| --- | --- | --- | --- | --- | --- |
| TextInput (text) | 102.0 KB | 73.3 KB | 19.8 KB | 59.1 KB | 1 |
| **NitroInput (text)** | 93.2 KB | 48.4 KB | 28.2 KB | 61.3 KB | 1 |
| **MorphInput (text)** | 241.7 KB | 203.8 KB | 23.6 KB | 231.3 KB | 1 |
