...
export interface NitroInputCanvasProps {
  mode?: Mode;
...
export interface NitroInputCanvasHandle {
  focus(): void;
  blur(): void;
  clear(): void;
...
export const NitroInputCanvas = forwardRef<NitroInputCanvasHandle, NitroInputCanvasProps>(
  function NitroInputCanvas(props, ref) {
    const {
      mode = 'text',
      fractionDigits = 2,
      maxIntegerDigits = 15,
