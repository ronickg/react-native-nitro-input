...
export interface NitroNumberCanvasProps {
  value: number;
...
export interface NitroNumberCanvasHandle {
...
export const NitroNumberCanvas = forwardRef<NitroNumberCanvasHandle, NitroNumberCanvasProps>(
  function NitroNumberCanvas(props, ref) {
    const {
      value,
      fractionDigits = 0,
    ...
    // Value / reveal prop machine — mirrors HybridNitroNumberView.commit().
