...
inputs; NitroInput and MorphInput format inside the native edit and never
...
<BenchChart group="type|8" metrics={['rewrites.keysWithRewrites', 'jsMsPerKey', 'settledMs.p95', 'dropped', 'mainMsPerKey']} caption="Hover a bar for every column of its row; the tables below have the same figures." />
...
<BenchChart group="type|8" metrics={['rewrites.keysWithRewrites', 'jsMsPerKey', 'settledMs.p95', 'dropped', 'mainMsPerKey']} caption="Hover a bar for every column of its row; the tables have the same figures." />
...
<BenchChart group="type|15" metrics={['rewrites.keysWithRewrites', 'jsMsPerKey', 'settledMs.p95', 'dropped', 'mainMsPerKey']} />
...
<BenchChart group="leak|20|40" metrics={['growthKbPerCycle']} caption="Growth per cycle of the footprint floor, the end minus the start over 40 cycles. A negative figure is a floor that ended lower than it began, nothing leaked and nothing to draw; a bar is what stayed allocated." />
