...
<Phones videos={[{ src: "/video/reveal.mp4" }]} caption="The count with tiers on a Galaxy A22, a budget Android phone, next to a progressive jackpot and live wins that never stop ticking." />
