---
title: Benchmarks
description: Release-build measurements of the components against the other libraries on npm, and of NumberFormat against Hermes' Intl, on an iPhone 11 Pro and a Samsung Galaxy A22.
---
