---
title: Benchmarks
description: Release-build measurements of both components against the other libraries on npm, and of NumberFormat against Hermes' Intl, on an iPhone 11 Pro and a Samsung Galaxy A22.
---
...
Per call on the JS thread, against Hermes' `Intl.NumberFormat`, six locale and currency setups. Details and the method are on the [NumberFormat page](/docs/number-format#measured).
