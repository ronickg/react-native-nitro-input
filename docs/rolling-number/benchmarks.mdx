...
sidebar_position: 11
title: Benchmarks
description: Release-build measurements against NumberFlow and react-native-animated-numbers on a simulator, an iPhone 13 Pro Max and a Pixel 10.
---
...
(`example/App.tsx` in the repository), release builds, React Native 0.87.1, Reanimated 4.6,
