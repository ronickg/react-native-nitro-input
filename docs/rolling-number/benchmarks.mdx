...
<BenchChart device="iPhone14,3" groups={['stream|24|frame', 'stream|24|10', 'stream|1|frame']} metrics={['ui.fps', 'ui.dropped', 'js.fps', 'cpu.main', 'cpu.js']} />
...
<BenchChart device="iPhone12,3" groups={['stream|24|frame', 'stream|24|10', 'stream|1|frame']} metrics={['ui.fps', 'ui.dropped', 'js.fps', 'cpu.main', 'cpu.js']} />
...
<BenchChart device="SM-A225F" groups={['stream|24|frame', 'stream|24|10', 'stream|1|frame']} metrics={['ui.fps', 'ui.dropped', 'js.fps', 'cpu.main', 'cpu.js']} />
...
<BenchChart group="leak|24|40" metrics={['growthKbPerCycle']} caption="Growth per cycle of the footprint floor, the end minus the start over 40 cycles. A negative figure is a floor that ended lower than it began, nothing leaked and nothing to draw; a bar is what stayed allocated." />
...
<BenchChart group="leaklist|200" metrics={['growthKbPerSecond']} caption="Footprint growth per second of scrolling, after the first six seconds. A negative figure is a footprint that fell over the run, nothing to draw; a bar is what kept rising." />
...
<BenchChart group="footprint|100" metrics={['perViewFootprintKb', 'perViewNativeKb', 'perViewJavaKb', 'leftFootprintKb']} caption="Medians of three interleaved rounds on the Galaxy A22, the first mount on the iPhones; the Java heap is Android only." />
