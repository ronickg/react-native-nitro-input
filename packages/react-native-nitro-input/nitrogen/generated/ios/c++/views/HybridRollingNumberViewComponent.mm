...
- (instancetype) init {
  if (self = [super init]) {
    ...
    std::shared_ptr<HybridRollingNumberViewSpec> hybridView = NitroInput::NitroInputAutolinking::createRollingNumberView();
...
- (void) updateView {
  // 1. Get Swift part
  NitroInput::HybridRollingNumberViewSpec_cxx& swiftPart = _hybridView->getSwiftPart();
...
+ (BOOL)shouldBeRecycled {
  return NitroInput::NitroInputAutolinking::isRollingNumberViewRecyclable();
}
