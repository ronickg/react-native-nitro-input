...
namespace margelo::nitro::nitroinput {
  ...
  public:
    ...
    explicit HybridRollingNumberViewSpecSwift(const NitroInput::HybridRollingNumberViewSpec_cxx& swiftPart):
      HybridObject(HybridRollingNumberViewSpec::TAG),
      _swiftPart(swiftPart) { }

  public:
    // Get the Swift part
    inline NitroInput::HybridRollingNumberViewSpec_cxx& getSwiftPart() noexcept {
      return _swiftPart;
    }
  ...
  private:
    NitroInput::HybridRollingNumberViewSpec_cxx _swiftPart;
  };
