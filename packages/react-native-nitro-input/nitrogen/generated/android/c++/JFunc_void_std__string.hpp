...
namespace margelo::nitro::nitroinput {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nitroinput/Func_void_std__string;";
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nitroinput/Func_void_std__string_cxx;";
