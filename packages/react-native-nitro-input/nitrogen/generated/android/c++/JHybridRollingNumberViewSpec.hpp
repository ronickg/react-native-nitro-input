...
namespace margelo::nitro::nitroinput {
  ...
  public:
    struct JavaPart: public jni::JavaClass<JavaPart, JHybridObject::JavaPart> {
      static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nitroinput/HybridRollingNumberViewSpec;";
      std::shared_ptr<JHybridRollingNumberViewSpec> getJHybridRollingNumberViewSpec();
    };
    struct CxxPart: public jni::HybridClass<CxxPart, JHybridObject::CxxPart> {
      static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nitroinput/HybridRollingNumberViewSpec$CxxPart;";
