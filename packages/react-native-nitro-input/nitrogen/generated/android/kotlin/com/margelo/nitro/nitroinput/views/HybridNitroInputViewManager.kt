///
/// HybridNitroInputViewManager.kt
...
/**
 * Represents the React Native `ViewManager` for the "NitroInputView" Nitro HybridView.
 */
public class HybridNitroInputViewManager: SimpleViewManager<View>() {
  /**
   * Represents the View and its last state snapshot (mutable)
   */
  private class HybridViewHolder(
    val hybridView: HybridNitroInputView,
    var lastState: StateWrapper? = null,
  )

  init {
    if (RecyclableView::class.java.isAssignableFrom(HybridNitroInputView::class.java)) {
  ...
  override fun getName(): String {
    return "NitroInputView"
  }

  override fun createViewInstance(reactContext: ThemedReactContext): View {
    val hybridView = HybridNitroInputView(reactContext)
  ...
  override fun updateState(view: View, props: ReactStylesDiffMap, stateWrapper: StateWrapper): Any? {
    ...
    HybridNitroInputViewStateUpdater.updateViewProps(hybridView, newState, oldState)
