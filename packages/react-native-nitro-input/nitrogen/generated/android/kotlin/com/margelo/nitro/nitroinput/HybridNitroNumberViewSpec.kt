...
abstract class HybridNitroNumberViewSpec: HybridView() {
  ...
  @set:DoNotStrip
  @set:Keep
  abstract var shimmerAngle: Double?
  
  @get:DoNotStrip
  @get:Keep
  @set:DoNotStrip
  @set:Keep
  abstract var shimmerWidth: Double?
  ...
  @set:DoNotStrip
  @set:Keep
  abstract var shimmerDirection: NitroNumberShimmerDirection?
  
  @get:DoNotStrip
  @get:Keep
  @set:DoNotStrip
  @set:Keep
  abstract var shimmerDelay: Double?
