...
/**
 * Represents the React Native `ViewManager` for the "NitroTextView" Nitro HybridView.
 */
public class HybridNitroTextViewManager: SimpleViewManager<View>() {
  /**
   * Represents the View and its last state snapshot (mutable)
   */
  private class HybridViewHolder(
    val hybridView: HybridNitroTextView,
    var lastState: StateWrapper? = null,
  )

  init {
    if (RecyclableView::class.java.isAssignableFrom(HybridNitroTextView::class.java)) {
  ...
  override fun createViewInstance(reactContext: ThemedReactContext): View {
    val hybridView = HybridNitroTextView(reactContext)
  ...
  override fun updateState(view: View, props: ReactStylesDiffMap, stateWrapper: StateWrapper): Any? {
    ...
    HybridNitroTextViewStateUpdater.updateViewProps(hybridView, newState, oldState)
