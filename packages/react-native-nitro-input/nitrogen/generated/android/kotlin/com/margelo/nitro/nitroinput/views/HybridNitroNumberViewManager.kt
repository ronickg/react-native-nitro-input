///
/// HybridNitroNumberViewManager.kt
...
/**
 * Represents the React Native `ViewManager` for the "NitroNumberView" Nitro HybridView.
 */
public class HybridNitroNumberViewManager: SimpleViewManager<View>() {
  /**
   * Represents the View and its last state snapshot (mutable)
   */
  private class HybridViewHolder(
    val hybridView: HybridNitroNumberView,
    var lastState: StateWrapper? = null,
  )

  init {
    if (RecyclableView::class.java.isAssignableFrom(HybridNitroNumberView::class.java)) {
  ...
  override fun getName(): String {
    return "NitroNumberView"
  }

  override fun createViewInstance(reactContext: ThemedReactContext): View {
    val hybridView = HybridNitroNumberView(reactContext)
  ...
  override fun updateState(view: View, props: ReactStylesDiffMap, stateWrapper: StateWrapper): Any? {
    ...
    HybridNitroNumberViewStateUpdater.updateViewProps(hybridView, newState, oldState)
