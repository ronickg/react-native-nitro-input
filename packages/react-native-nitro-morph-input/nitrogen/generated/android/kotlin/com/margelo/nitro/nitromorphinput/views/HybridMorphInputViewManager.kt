///
/// HybridMorphInputViewManager.kt
...
/**
 * Represents the React Native `ViewManager` for the "MorphInputView" Nitro HybridView.
 */
public class HybridMorphInputViewManager: SimpleViewManager<View>() {
  /**
   * Represents the View and its last state snapshot (mutable)
   */
  private class HybridViewHolder(
    val hybridView: HybridMorphInputView,
    var lastState: StateWrapper? = null,
  )

  init {
    if (RecyclableView::class.java.isAssignableFrom(HybridMorphInputView::class.java)) {
  ...
  override fun getName(): String {
    return "MorphInputView"
  }

  override fun createViewInstance(reactContext: ThemedReactContext): View {
    val hybridView = HybridMorphInputView(reactContext)
  ...
  override fun updateState(view: View, props: ReactStylesDiffMap, stateWrapper: StateWrapper): Any? {
    ...
    HybridMorphInputViewStateUpdater.updateViewProps(hybridView, newState, oldState)
