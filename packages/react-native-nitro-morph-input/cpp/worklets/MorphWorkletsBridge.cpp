...
namespace margelo::nitro::nitromorphinput::morphworklets {
...
constexpr auto kRegistry = "__morphInputWorklets";
...
void logError(Runtime& rt, const std::string& message) {
  try {
    ...
    console.getPropertyAsFunction(rt, "error").call(rt, String::createFromUtf8(rt, "[MorphInput] worklet threw: " + message));
