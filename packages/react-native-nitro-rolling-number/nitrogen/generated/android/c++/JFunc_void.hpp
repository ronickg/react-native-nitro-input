...
namespace margelo::nitro::nitrorollingnumber {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nitrorollingnumber/Func_void;";
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nitrorollingnumber/Func_void_cxx;";
