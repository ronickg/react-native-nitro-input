///
/// HybridRollingNumberViewManager.kt
/// This file was generated by nitrogen. DO NOT MODIFY THIS FILE.
/// https://github.com/mrousavy/nitro
/// Copyright © Marc Rousavy @ Margelo
///

package com.margelo.nitro.nitrorollingnumber.views
...
import com.margelo.nitro.nitrorollingnumber.*

/**
 * Represents the React Native `ViewManager` for the "RollingNumberView" Nitro HybridView.
 */
public class HybridRollingNumberViewManager: SimpleViewManager<View>() {
  /**
   * Represents the View and its last state snapshot (mutable)
   */
  private class HybridViewHolder(
    val hybridView: HybridRollingNumberView,
    var lastState: StateWrapper? = null,
  )

  init {
    if (RecyclableView::class.java.isAssignableFrom(HybridRollingNumberView::class.java)) {
  ...
  override fun createViewInstance(reactContext: ThemedReactContext): View {
    val hybridView = HybridRollingNumberView(reactContext)
  ...
  override fun updateState(view: View, props: ReactStylesDiffMap, stateWrapper: StateWrapper): Any? {
    ...
    HybridRollingNumberViewStateUpdater.updateViewProps(hybridView, newState, oldState)
